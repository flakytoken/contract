 ...
 * 3% amount of token is automatically burned. 
 * 3% amount of token is automatically added to LP.
 * 2% amount of token is automatically sent to holders. 
 * 2% amount of token is automatically sent to marketing wallet.
 
 * Flaky Token (FLAKY), inspired by the beloved Happy Tree Friends character Flaky,
  is set to make a significant impact in the crypto market. Combining Flaky's timid yet loyal nature with blockchain technology,
  FLAKY offers investors a fun and rewarding experience. With its limited supply, community-focused events, and unique loyalty program,
  Flaky Token is poised to stand out in the crypto world.
**/
...
contract FLAKY is Context, IERC20, Ownable {
    ...
    string private _name = "FLAKY";
    string private _symbol = "FLAKY";
    ...
    address public marketingWallet = 0x297Ba6c66d12E243d6c132d8FA852196c4040994 ;
